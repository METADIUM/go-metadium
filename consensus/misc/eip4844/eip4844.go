...
// accordingly.
//
// Note: Metadium uses *big.Int for ExcessBlobGas and BlobGasUsed in the Header.
func VerifyEIP4844Header(parent, header *types.Header) error {
	...
	blobGasUsed := header.BlobGasUsed.Uint64()
