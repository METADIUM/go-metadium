...
func ExecutableDataToBlock(params ExecutableData, versionedHashes []common.Hash, beaconRoot *common.Hash) (*types.Block, error) {
	...
	header := &types.Header{
		...
		ExcessBlobGas:    uint64ToBigInt(params.ExcessBlobGas),
		BlobGasUsed:      uint64ToBigInt(params.BlobGasUsed),
...
// uint64ToBigInt converts a *uint64 to *big.Int, returning nil if input is nil.
