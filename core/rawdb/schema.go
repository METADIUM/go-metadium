...
var (
	...
	blockBlobSidecarsPrefix = []byte("s") // blockBlobSidecarsPrefix + num (uint64 big endian) + hash -> blob sidecars
...
// blockBlobSidecarsKey = blockBlobSidecarsPrefix + num (uint64 big endian) + hash
