...
var (
	...
	// Deprecated test network genesis hashes (kept for bootnodes.go compatibility)
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "avocadoBlock", block: c.AvocadoBlock, optional: true},
		{name: "pangyoBlock", block: c.PangyoBlock, optional: true},
		{name: "applepieBlock", block: c.ApplepieBlock, optional: true},
		{name: "bokbunjaBlock", block: c.BokbunjaBlock, optional: true},
		{name: "camelliaBlock", block: c.CamelliaBlock, optional: true},
...
// isForked is an alias for isBlockForked used for Metadium-specific forks.
func isForked(s, head *big.Int) bool {
	return isBlockForked(s, head)
}
