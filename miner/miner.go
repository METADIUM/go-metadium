...
// TxPool defines the interface for a transaction pool used by the miner.
...
// BlobAwareBackend is implemented by backends that support a full (blob-aware) tx pool.
